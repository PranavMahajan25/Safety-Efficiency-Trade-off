...
if __name__ == "__main__":
    ...
    # model_name = 'gng_PAL_fixed'
    model_name = 'gng_PAL1'
    # model_name = 'gng_PAL2b'
    # model_name = 'gng_PAL2w'
    # model_name = 'gng_PAL3wb'
    # model_name = 'gng_PAL4wb_flexible'
    model_code = open('./stan_files/'+model_name+'.stan', 'r').read()
    # data = pd.read_csv('subj04-07_hbayesdata.txt', sep='\t')
    data = pd.read_csv('21_subj_hbayesdata.txt', sep='\t')
