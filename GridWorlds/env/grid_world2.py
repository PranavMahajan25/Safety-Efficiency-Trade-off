...
class GridWorld:
    ...
    goal_states : numpy arrany of shape (n, 2)
        ...
        states.
    """
    def __init__(self, num_rows, num_cols, start_state, goal_states=None):
    ...
    def add_obstructions(self, obstructed_states=None, bad_states=None, restart_states=None, surprise_states=None, novel_states=None):
        """
        ...
        if novel_states is not None:
            self.num_novel_states = novel_states.shape[0]
        else:
    ...
    def create_gridworld(self):
        ...
        self.novel_tag = np.zeros((self.num_states, 1))
        ...
        # tag the novel states
        for i in range(self.num_novel_states):
            novel_state = row_col_to_seq(self.novel_states[i,:].reshape(1,-1), self.num_cols)
            self.novel_tag[novel_state, :] = 1
