## All this script does is change the num_actions from 4 to 5.
## The actual immobility action is not coded in this script but 
## it is coded in pavlovian_instrumental_transfer_colearn_truncated.py

# N - 0, S - 1, E - 2, W  3, Do Nothing - 4
...
class GridWorld:
    ...
    def __init__(self, num_rows, num_cols, start_state, goal_states):
        ...
        self.r_painful_movement = None
        self.painful_action = -1
    ...
    def add_rewards(self, step_reward, goal_reward, bad_state_reward=None, restart_state_reward = None, surprise_state_min_reward=None, surprise_state_max_reward=None, wallbump_reward = None):
        """
    ...
    def create_gridworld(self):
        ...
        ## Add movement related pain
        if self.r_painful_movement is not None and self.painful_action != -1:
            self.R[:, self.painful_action] = self.r_painful_movement
        ...
        for action in range(self.num_actions):
            for state in range(self.num_states):
                ...
                # Immobilize ## Although not that this is required as the PIT colearn truncated script does the job
                if action == 4:
                    self.P[state, state, action] = 1
                    continue
    ...
    def _get_direction(self, action, direction):
        ...
        ----------
        action : int
            The current action 0, 1, 2, 3 (and 4 - immobilise) for gridworld.
